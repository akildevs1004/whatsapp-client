...
async function start({
  ...
  const args = {
    ...
    args: [
      ...
      "--disable-extensions",
      //"--headless", // Runs browser in headless mode (without UI)
    ],
  };
  try {
    ...
    session = true;
    console.log("page Authenticating...................");
...
async function sendTo(phoneOrContact, message) {
  ...
  try {
    ...
    await page.waitForSelector(SELECTORS.SEND_BUTTON, { timeout: 1000 * 60 });
